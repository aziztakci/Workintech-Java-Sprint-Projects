...
import com.workintech.fswebs18challengemaven.exceptions.CardException; // GÜNCELLEME: Custom Exception eklendi
import jakarta.persistence.EntityManager;
import jakarta.persistence.TypedQuery;
import jakarta.transaction.Transactional;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.http.HttpStatus; // GÜNCELLEME: HttpStatus eklendi
...
public class CardRepositoryImpl implements CardRepository {
    ...
    public Card findById(Long id) {
        ...
        if (card == null) {
            throw new CardException("Verilen id ile bir kart bulunamadı: " + id, HttpStatus.NOT_FOUND);
        }
        return card;
    }
    ...
    public List<Card> findByColor(String color) {
        ...
        if (cards.isEmpty()) {
            throw new CardException("Verilen renkte kart bulunamadı: " + color, HttpStatus.NOT_FOUND);
        }
        return cards;
    }
    ...
    public List<Card> findByType(String type) {
        ...
        if (cards.isEmpty()) {
            throw new CardException("Verilen tipte kart bulunamadı: " + type, HttpStatus.NOT_FOUND);
        }
        return cards;
    }
    ...
    public List<Card> findByValue(Integer value) {
        ...
        if (cards.isEmpty()) {
            throw new CardException("Verilen değerde kart bulunamadı: " + value, HttpStatus.NOT_FOUND);
        }
        return cards;
    }
